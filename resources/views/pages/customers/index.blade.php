        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    form-control-solid
                    w-250px ps-15" placeholder="Search Customers"/>
                </div>

                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    <a href="{{ route('admin.customers.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                       title="Add Customer">
                        <span class="svg-icon svg-icon-2">...</span>
                        Add Customer
                    </a>
            ...
            <table data-url="{{ $allCustomersUrl }}" data-delete-base-url="{{ $deleteBaseUrl }}"
                ...
                "columns": [
                    ...
                    { "data": "updated_at","name": "updated_at", },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            let editUrl = "{{ route('admin.customers.index') }}/" + data.id + "/edit";
