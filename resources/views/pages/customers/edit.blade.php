...
@section('content')
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Customer Details</h1>
            </div>
        </div>
    </div>
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
            {{--  =============================================  --}}
            <form id="customer-update-form" class="form" method="post" action="{{ $customerUpdateUrl }}" autocomplete="off">
                @csrf
                <div class="fv-row mb-10">
                    <label class="required form-label fs-6 mb-2">Name</label>
                    <input value="{{ $customer?->name ?? '' }}" class="form-control form-control-lg form-control-solid"
                           type="text"
                           placeholder=""
                ...
                <div class="fv-row mb-10">
                    ...
                    <input value="{{ $customer?->email ?? '' }}" class="form-control form-control-lg
                ...
                <div class="fv-row mb-10">
                    ...
                    <input value="{{ $customer?->phone ?? '' }}" class="form-control form-control-lg form-control-solid" type="tel" placeholder=""
                ...
                <div class="fv-row mb-10">
                    ...
                    form-control-solid">{{ $customer?->address ?? '' }}</textarea>
                </div>

                <button id="customer-update-form-submit" type="submit" class="btn btn-primary">Submit</button>
                <a href="{{ route('admin.customers.index') }}" id="customer-update-form-cancel" class="btn
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire({
                                ...
                                location.href = $('#customer-update-form-cancel').attr('href');
                            });
                        },
