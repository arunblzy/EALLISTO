    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">All Invoices
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    form-control-solid
                    w-250px ps-15" placeholder="Search Invoices"/>
                </div>

                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    <a href="{{ route('admin.invoices.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                       title="Add Invoice">
                        <span class="svg-icon svg-icon-2">...</span>
                        Add Invoice
                    </a>
            ...
            <table data-url="{{ $allInvoicesUrl }}" data-delete-base-url="{{ $deleteBaseUrl }}"
                ...
                "columns": [
                    ...
                    { "data": "updated_at","name": "updated_at", },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            let editUrl = "{{ route('admin.invoices.index') }}/" + data.id + "/edit";
